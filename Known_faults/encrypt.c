...
unsigned char tg[16], ftag[ 16 ], nfstate[32], fstate[32];
...
int faulty_crypto_aead_decrypt(
                        unsigned char *m, unsigned long long *mlen,
                        unsigned char *nsec,
                        const unsigned char *c, unsigned long long clen,
                        const unsigned char *ad, unsigned long long adlen,
                        const unsigned char *npub,
                        const unsigned char *k, const unsigned char fault, const unsigned char pos
                        )
{
    /*################################################################################################################
...
##############################################################################################################*/
        ...
        faulty_tag(photon_in,fault, pos);
        
        for (int j=0;j<32;j++)
        	fstate[j] = photon_in[j];
